...
[Table("PermissionInstance"), UsedImplicitly(ImplicitUseTargetFlags.WithMembers)]
public class InstancePermissionSet {
  ...
  [NotMapped]
  protected IEnumerable<PSMPermission> ValidPermissions { get; } = ArraySegment<PSMPermission>.Empty;

  [NotMapped]
  public Instance InstanceOwner = null!;
}
